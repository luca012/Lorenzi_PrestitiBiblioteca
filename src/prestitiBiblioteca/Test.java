...
public class Test {
	...
	public static void menu() {
		...
		System.out.println("10. Scrivi file CSV soci");
		System.out.println("11. Leggi file CSV soci");
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 9:
				...
				break;
			case 10:
				String nomeFile = input.inputString("\nInserire nome file soci da scrivere:");
				b.writeSoci(nomeFile);
				break;
			case 11:
				String nomeFile2 = input.inputString("\nInserire nome file soci da leggere:");
				b.readSoci(nomeFile2);
			}
		} while (scelta != 0);
	}
